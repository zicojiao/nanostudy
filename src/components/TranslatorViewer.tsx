      ...
      <Card className="w-full">
        <CardHeader className="pb-3">
          ...
          <div className="flex items-center gap-2 text-sm mt-2">
            ...
            >
              <SelectTrigger className="font-medium border border-slate-200/60 rounded-lg px-3 py-2 bg-white hover:border-primary/40 transition-colors w-[200px]">
        ...
        <CardContent className="pt-4">
          ...
          {/* Error Display */}
          {state.error && (
            <div className="text-xs text-red-600 bg-red-50/80 border border-red-200/60 p-3 rounded-lg">
              {state.error}
            </div>
          )}
        </CardContent>
        ...
        <div className="space-y-4">
          ...
          <Card className="w-full">
            ...
            <CardContent className="pt-0">
              <Textarea
                ...
                className="min-h-[120px] resize-none border-slate-200/60 rounded-xl focus:ring-2 focus:ring-primary/20 transition-all"
          ...
          {translatedText && (
            <Card className="w-full">
              ...
              <CardContent className="pt-0">
                <div className="bg-gradient-to-br from-primary/5 to-accent/30 p-4 rounded-xl border border-primary/10 min-h-[120px] shadow-inner">
